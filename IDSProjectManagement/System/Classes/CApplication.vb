...
Friend Class CApplication
        ...
        Try
            For Each oCtrl As Control In Page.Controls
                ...
                ElseIf TypeOf oCtrl Is PictureBox Then
                    ...
                    CType(oCtrl, PictureBox).Image = New Bitmap(Global.IDSProjectManagement.My.Resources.NoImage)
    ...
    Public Shared Sub SetFormFormat(ByVal value As Object)

        value.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedSingle
        value.MaximizeBox = False
        value.MinimizeBox = False
        value.Size = New Size(1000, 316)
        value.Icon = GetApplicationIcon()
