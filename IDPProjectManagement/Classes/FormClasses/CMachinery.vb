...
Public Class CMachinery
    ...
    Friend Function GetClassData(guid As String) As CMachinery

        Try

            Using oConnection As SqlConnection = CApplicationController.oCDataBase.GetSQLConnection()

                Using oSqlCommand As New SqlCommand("dbo.SP_MACHINERY", oConnection) With {.CommandType = CommandType.StoredProcedure}
    ...
    Public Shared Function SetControlsBinding(ByVal oForm As FMachinery) As Boolean
    ...
    Public Shared Sub SetGridPropertiesFormat(ByVal oForm As FMachinery)
    ...
    Public Shared Function SetControlsBindingOnNew(ByVal oForm As FMachinery) As Boolean
    ...
    Public Shared Sub SetControlPropertiesFormat(ByVal oForm As FMachinery)
    ...
    Public Shared Sub SetGeneralFormat(ByVal oForm As FMachinery)
            ...
            With oSqlCommand.Parameters
                ...
                Select Case spCommandValue
                    ...
                    Case SPCommand.Save
                        ...
                        .Add("@centro_id", SqlDbType.VarChar).Value = DirectCast(oForm, FMachinery).FormRelatedClass.centro_id
                        .Add("@nombre_corto", SqlDbType.VarChar).Value = DirectCast(oForm, FMachinery).FormRelatedClass.nombre_corto
                        .Add("@nombre", SqlDbType.VarChar).Value = DirectCast(oForm, FMachinery).FormRelatedClass.nombre
                        .Add("@descripcion", SqlDbType.VarChar).Value = DirectCast(oForm, FMachinery).FormRelatedClass.descripcion
                        .Add("@is_active", SqlDbType.Bit).Value = DirectCast(oForm, FMachinery).FormRelatedClass.is_active
                    ...
                    Case SPCommand.Delete
                        ...
                        .Add("@guid", SqlDbType.VarChar).Value = DirectCast(oForm, FMachinery).FormRelatedClass.guid
    ...
    End Sub
    Public Shared Function SaveRecord(ByVal oForm As FMachinery) As Boolean
    ...
    Public Shared Function UpdateRecord(ByVal oForm As FMachinery) As Boolean
        ...
        Try
            ...
            Using oConnection As SqlConnection = CApplicationController.oCDataBase.GetSQLConnection()
                ...
                Using oSqlCommand As New SqlCommand(oForm.stored_procedure_name, oConnection) With {.CommandType = CommandType.StoredProcedure}
                    ...
                    'If Not CMachinery.PrepareSPCommand(oSqlCommand, SPCommand.Update, oForm) Then Throw New CustomException
    ...
    Public Shared Function DeleteRecord(ByVal oForm As FMachinery) As Boolean
        ...
        Try
            ...
            Using oConnection As SqlConnection = CApplicationController.oCDataBase.GetSQLConnection()
                ...
                Using oSqlCommand As New SqlCommand(oForm.stored_procedure_name, oConnection) With {.CommandType = CommandType.StoredProcedure}
                    ...
                    ' ---------------------------------
                    'If Not CMachinery.PrepareSPCommand(oSqlCommand, SPCommand.Delete, oForm) Then Throw New CustomException
