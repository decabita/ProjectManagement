...
Public Class CMeasurement
    ...
    Friend Function GetClassData(guid As String) As CMeasurement

        Try

            Using oConnection As SqlConnection = CApplicationController.oCDataBase.GetSQLConnection()

                Using oSqlCommand As New SqlCommand("dbo.SP_MEASUREMENTS", oConnection) With {.CommandType = CommandType.StoredProcedure}
    ...
    Public Shared Function SetControlsBinding(ByVal oForm As FMeasurements) As Boolean
    ...
    Public Shared Sub SetGridPropertiesFormat(ByVal oForm As FMeasurements)
    ...
    Public Shared Function SetControlsBindingOnNew(ByVal oForm As FMeasurements) As Boolean
    ...
    Public Shared Sub SetControlPropertiesFormat(ByVal oForm As FMeasurements)
    ...
    Public Shared Sub SetGeneralFormat(ByVal oForm As FMeasurements)
            ...
            With oSqlCommand.Parameters
                ...
                Select Case spCommandValue
                    ...
                    Case SPCommand.Save
                        ...
                        .Add("@centro_id", SqlDbType.VarChar).Value = DirectCast(oForm, FMeasurements).FormRelatedClass.centro_id
                        .Add("@nombre_corto", SqlDbType.VarChar).Value = DirectCast(oForm, FMeasurements).FormRelatedClass.nombre_corto
                        .Add("@nombre", SqlDbType.VarChar).Value = DirectCast(oForm, FMeasurements).FormRelatedClass.nombre
                        .Add("@descripcion", SqlDbType.VarChar).Value = DirectCast(oForm, FMeasurements).FormRelatedClass.descripcion
                        .Add("@is_active", SqlDbType.Bit).Value = DirectCast(oForm, FMeasurements).FormRelatedClass.is_active
                    ...
                    Case SPCommand.Delete
                        ...
                        .Add("@guid", SqlDbType.VarChar).Value = DirectCast(oForm, FMeasurements).FormRelatedClass.guid
    ...
    End Sub
    Public Shared Function SaveRecord(ByVal oForm As FMeasurements) As Boolean
    ...
    Public Shared Function UpdateRecord(ByVal oForm As FMeasurements) As Boolean
        ...
        Try
            ...
            Using oConnection As SqlConnection = CApplicationController.oCDataBase.GetSQLConnection()
                ...
                Using oSqlCommand As New SqlCommand(oForm.stored_procedure_name, oConnection) With {.CommandType = CommandType.StoredProcedure}
                    ...
                    'If Not CMeasurement.PrepareSPCommand(oSqlCommand, SPCommand.Update, oForm) Then Throw New CustomException
    ...
    Public Shared Function DeleteRecord(ByVal oForm As FMeasurements) As Boolean
        ...
        Try
            ...
            Using oConnection As SqlConnection = CApplicationController.oCDataBase.GetSQLConnection()
                ...
                Using oSqlCommand As New SqlCommand(oForm.stored_procedure_name, oConnection) With {.CommandType = CommandType.StoredProcedure}
                    ...
                    ' ---------------------------------
                    'If Not CMeasurement.PrepareSPCommand(oSqlCommand, SPCommand.Delete, oForm) Then Throw New CustomException
