...
Public Class FVendors

    Private _oCVendor As New CVendor
    Public Property FormRelatedClass() As CVendor
        Get
            Return _oCVendor
        End Get
        Set(ByVal value As CVendor)
            _oCVendor = value
        End Set
    End Property
    ...
    Private oCVendor As CVendor = New CVendor()
    ...
    Private Sub FVendors_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        'Properties in Form Templete
        stored_procedure_name = "dbo.SP_VENDORS"
        ...
        Me.FormRelatedClass = New CVendor

        Call CommandFind()

        Call Me.CommandQuery()

        Call CVendor.SetGeneralFormat(Me)
    ...
    Private Sub BWorkerGetData_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BWorkerGetData.RunWorkerCompleted
        ...
        Try
            ...
            Call CVendor.SetControlsBinding(Me)

            ' Establece formato de los controles.
            Call CVendor.SetGridPropertiesFormat(Me)

            Call CVendor.SetControlPropertiesFormat(Me)
    ...
    End Sub
    Private Sub FVendors_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    End Sub
    Private Sub FVendors_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate

        If Not Me.form_state = CApplication.ControlState.InitState Then Call CommandCancel()

    End Sub
    Private Sub FVendors_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Dim PrepareSPAction As Action(Of SqlCommand, Integer, Form) = AddressOf CVendor.PrepareSPCommand
    ...
    Protected Friend Overrides Function CommandDelete() As Boolean
        ...
        Try
            ...
            With Me
                ...
                '-------------------------------------------------
                Me.FormRelatedClass = New CVendor With {
                    .centro_id = CApplicationController.oCWorkCenter_.id,
                    .nombre_corto = Me.tClaveId.Text,
                    .guid = Me.tGuid.Text
                }

                If Not CVendor.DeleteRecord(Me) Then Me.form_state = CApplication.ControlState.InitState : Throw New CustomException("Error al eliminar.")
        ...
        Try
            With Me
                ...
                If Me.form_state = CApplication.ControlState.Add Then
                    ...
                    If Not CVendor.SaveRecord(Me) Then
                ...
                ElseIf Me.form_state = CApplication.ControlState.Edit Then
                    ...
                    If Not CVendor.UpdateRecord(Me) Then
    ...
    Dim SetControlsBindingOnNewAction As Action(Of Form) = AddressOf CVendor.SetControlsBindingOnNew
