...
Public Class FMachinery

    Private _oCMachinery As New CMachinery
    Public Property FormRelatedClass() As CMachinery
        Get
            Return _oCMachinery
        End Get
        Set(ByVal value As CMachinery)
            _oCMachinery = value
        End Set
    End Property
    ...
    Private oCMachinery As CMachinery = New CMachinery()
    ...
    Private Sub FMachinery_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        'Properties in Form Templete
        stored_procedure_name = "dbo.SP_MACHINERY"
        ...
        Me.FormRelatedClass = New CMachinery

        Call CommandFind()

        Call Me.CommandQuery()

        Call CMachinery.SetGeneralFormat(Me)
    ...
    Private Sub BWorkerGetData_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BWorkerGetData.RunWorkerCompleted
        ...
        Try
            ...
            Call CMachinery.SetControlsBinding(Me)

            ' Establece formato de los controles.
            Call CMachinery.SetGridPropertiesFormat(Me)

            Call CMachinery.SetControlPropertiesFormat(Me)
    ...
    End Sub
    Private Sub FMachinery_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    End Sub
    Private Sub FMachinery_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate

        If Not Me.form_state = CApplication.ControlState.InitState Then Call CommandCancel()

    End Sub
    Private Sub FMachinery_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Dim PrepareSPAction As Action(Of SqlCommand, Integer, Form) = AddressOf CMachinery.PrepareSPCommand
    ...
    Protected Friend Overrides Function CommandDelete() As Boolean
        ...
        Try
            ...
            With Me
                ...
                '-------------------------------------------------
                Me.FormRelatedClass = New CMachinery With {
                    .centro_id = CApplicationController.oCWorkCenter_.id,
                    .nombre_corto = Me.tClaveId.Text,
                    .guid = Me.tGuid.Text
                }

                If Not CMachinery.DeleteRecord(Me) Then Me.form_state = CApplication.ControlState.InitState : Throw New CustomException("Error al eliminar.")
        ...
        Try
            With Me
                ...
                If Me.form_state = CApplication.ControlState.Add Then
                    ...
                    If Not CMachinery.SaveRecord(Me) Then
                ...
                ElseIf Me.form_state = CApplication.ControlState.Edit Then
                    ...
                    If Not CMachinery.UpdateRecord(Me) Then
    ...
    Dim SetControlsBindingOnNewAction As Action(Of Form) = AddressOf CMachinery.SetControlsBindingOnNew
