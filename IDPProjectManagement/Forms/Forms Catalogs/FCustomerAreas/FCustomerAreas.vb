...
Public Class FCustomerAreas

    Private _oCCustomerArea As New CCustomerArea
    Public Property FormRelatedClass() As CCustomerArea
        Get
            Return _oCCustomerArea
        End Get
        Set(ByVal value As CCustomerArea)
            _oCCustomerArea = value
        End Set
    End Property
    ...
    Private oCCustomerArea As CCustomerArea = New CCustomerArea()
    ...
    Private Sub FCustomerAreas_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        'Properties in Form Templete
        stored_procedure_name = "dbo.SP_CUSTOMER_AREAS"
        ...
        Me.FormRelatedClass = New CCustomerArea

        Call CommandFind()

        Call Me.CommandQuery()

        Call CCustomerArea.SetGeneralFormat(Me)
    ...
    Private Sub BWorkerGetData_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BWorkerGetData.RunWorkerCompleted
        ...
        Try
            ...
            Call CCustomerArea.SetControlsBinding(Me)

            ' Establece formato de los controles.
            Call CCustomerArea.SetGridPropertiesFormat(Me)

            Call CCustomerArea.SetControlPropertiesFormat(Me)
    ...
    End Sub
    Private Sub FCustomerAreas_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    End Sub
    Private Sub FCustomerAreas_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate

        If Not Me.form_state = CApplication.ControlState.InitState Then Call CommandCancel()

    End Sub
    Private Sub FCustomerAreas_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Dim PrepareSPAction As Action(Of SqlCommand, Integer, Form) = AddressOf CCustomerArea.PrepareSPCommand
    ...
    Protected Friend Overrides Function CommandDelete() As Boolean
        ...
        Try
            ...
            With Me
                ...
                '-------------------------------------------------
                Me.FormRelatedClass = New CCustomerArea With {
                    .centro_id = CApplicationController.oCWorkCenter_.id,
                    .nombre_corto = Me.tClaveId.Text,
                    .guid = Me.tGuid.Text
                }

                If Not CCustomerArea.DeleteRecord(Me) Then Me.form_state = CApplication.ControlState.InitState : Throw New CustomException("Error al eliminar.")
        ...
        Try
            With Me
                ...
                If Me.form_state = CApplication.ControlState.Add Then
                    ...
                    If Not CCustomerArea.SaveRecord(Me) Then
                ...
                ElseIf Me.form_state = CApplication.ControlState.Edit Then
                    ...
                    If Not CCustomerArea.UpdateRecord(Me) Then
    ...
    Dim SetControlsBindingOnNewAction As Action(Of Form) = AddressOf CCustomerArea.SetControlsBindingOnNew
