...
Public Class FProspects

    Private _oCurrentForm As New CProspect
    Public Property FormRelatedClass() As CProspect
        Get
            Return _oCurrentForm
        End Get
        Set(ByVal value As CProspect)
            _oCurrentForm = value
        End Set
    End Property
    ...
    Private Sub FProspects_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        'Properties in Form Templete
        stored_procedure_name = "dbo.SP_PROSPECTS"
        ...
        Me.FormRelatedClass = New CProspect

        Call CommandFind()

        Call Me.CommandQuery()

        Call CProspect.SetGeneralFormat(Me)
    ...
    Private Sub BWorkerGetData_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BWorkerGetData.RunWorkerCompleted
        ...
        Try
            ...
            Call CProspect.SetControlsBinding(Me)

            ' Establece formato de los controles.
            Call CProspect.SetGridPropertiesFormat(Me)

            Call CProspect.SetControlPropertiesFormat(Me)
    ...
    End Sub
    Private Sub FProspects_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    End Sub
    Private Sub FProspects_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate

        If Not Me.form_state = CApplication.ControlState.InitState Then Call CommandCancel()

    End Sub
    Private Sub FProspects_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Dim PrepareSPAction As Action(Of SqlCommand, Integer, Form) = AddressOf CProspect.PrepareSPCommand
    ...
    Protected Friend Overrides Function CommandDelete() As Boolean
        ...
        Try
            ...
            With Me
                ...
                '-------------------------------------------------
                Me.FormRelatedClass = New CProspect With {
                    .centro_id = CApplicationController.oCWorkCenter_.id,
                    .nombre_corto = Me.tClaveId.Text,
                    .guid = Me.tGuid.Text
                }

                If Not CProspect.DeleteRecord(Me) Then Me.form_state = CApplication.ControlState.InitState : Throw New CustomException("Error al eliminar.")
        ...
        Try
            With Me
                ...
                If Me.form_state = CApplication.ControlState.Add Then
                    ...
                    If Not CProspect.SaveRecord(Me) Then
                ...
                ElseIf Me.form_state = CApplication.ControlState.Edit Then
                    ...
                    If Not CProspect.UpdateRecord(Me) Then
    ...
    Dim SetControlsBindingOnNewAction As Action(Of Form) = AddressOf CProspect.SetControlsBindingOnNew
