...
Public Class FActivities
    ...
    Private _oCActivity As New CActivity
    Public Property FormRelatedClass() As CActivity
        Get
            Return _oCActivity
        End Get
        Set(ByVal value As CActivity)
            _oCActivity = value
        End Set
    End Property
    ...
    Private oCActivity As CActivity = New CActivity()
    ...
    Private Sub FActivities_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        'Properties in Form Templete
        stored_procedure_name = "dbo.SP_ACTIVITIES"
        ...
        Me.FormRelatedClass = New CActivity

        Call CommandFind()

        Call Me.CommandQuery()

        Call CActivity.SetGeneralFormat(Me)
    ...
    Private Sub BWorkerGetData_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BWorkerGetData.RunWorkerCompleted
        ...
        Try
            ...
            Call CActivity.SetControlsBinding(Me)

            ' Establece formato de los controles.
            Call CActivity.SetGridPropertiesFormat(Me)

            Call CActivity.SetControlPropertiesFormat(Me)
    ...
    End Sub
    Private Sub FActivities_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    End Sub
    Private Sub FActivities_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate

        If Not Me.form_state = CApplication.ControlState.InitState Then Call CommandCancel()

    End Sub
    Private Sub FActivities_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Dim PrepareSPAction As Action(Of SqlCommand, Integer, Form) = AddressOf CActivity.PrepareSPCommand
    ...
    Protected Friend Overrides Function CommandDelete() As Boolean
        ...
        Try
            ...
            With Me
                ...
                '-------------------------------------------------
                Me.FormRelatedClass = New CActivity With {
                    .centro_id = CApplicationController.oCWorkCenter_.id,
                    .nombre_corto = Me.tClaveId.Text,
                    .guid = Me.tGuid.Text
                }

                If Not CActivity.DeleteRecord(Me) Then Me.form_state = CApplication.ControlState.InitState : Throw New CustomException("Error al eliminar.")
        ...
        Try
            With Me
                ...
                If Me.form_state = CApplication.ControlState.Add Then
                    ...
                    If Not CActivity.SaveRecord(Me) Then
                ...
                ElseIf Me.form_state = CApplication.ControlState.Edit Then
                    ...
                    If Not CActivity.UpdateRecord(Me) Then
    ...
    Dim SetControlsBindingOnNewAction As Action(Of Form) = AddressOf CActivity.SetControlsBindingOnNew
