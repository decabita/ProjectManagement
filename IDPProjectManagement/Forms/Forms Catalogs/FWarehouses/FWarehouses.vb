...
Public Class FWarehouses
    ...
    Private _oCWarehouse As New CWarehouse
    Public Property FormRelatedClass() As CWarehouse
        Get
            Return _oCWarehouse
        End Get
        Set(ByVal value As CWarehouse)
            _oCWarehouse = value
        End Set
    End Property
    ...
    Private oCWarehouse As CWarehouse = New CWarehouse()
    ...
    Private Sub FWarehouses_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        'Properties in Form Templete
        stored_procedure_name = "dbo.SP_WAREHOUSES"
        ...
        Me.FormRelatedClass = New CWarehouse

        Call CommandFind()

        Call Me.CommandQuery()

        Call CWarehouse.SetGeneralFormat(Me)
    ...
    Private Sub BWorkerGetData_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BWorkerGetData.RunWorkerCompleted
        ...
        Try
            ...
            Call CWarehouse.SetControlsBinding(Me)

            ' Establece formato de los controles.
            Call CWarehouse.SetGridPropertiesFormat(Me)

            Call CWarehouse.SetControlPropertiesFormat(Me)
    ...
    End Sub
    Private Sub FWarehouses_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    End Sub
    Private Sub FWarehouses_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate

        If Not Me.form_state = CApplication.ControlState.InitState Then Call CommandCancel()

    End Sub
    Private Sub FWarehouses_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Dim PrepareSPAction As Action(Of SqlCommand, Integer, Form) = AddressOf CWarehouse.PrepareSPCommand
    ...
    Protected Friend Overrides Function CommandDelete() As Boolean
        ...
        Try
            ...
            With Me
                ...
                '-------------------------------------------------
                Me.FormRelatedClass = New CWarehouse With {
                    .centro_id = CApplicationController.oCWorkCenter_.id,
                    .nombre_corto = Me.tClaveId.Text,
                    .guid = Me.tGuid.Text
                }

                If Not CWarehouse.DeleteRecord(Me) Then Me.form_state = CApplication.ControlState.InitState : Throw New CustomException("Error al eliminar.")
        ...
        Try
            With Me
                ...
                If Me.form_state = CApplication.ControlState.Add Then
                    ...
                    If Not CWarehouse.SaveRecord(Me) Then
                ...
                ElseIf Me.form_state = CApplication.ControlState.Edit Then
                    ...
                    If Not CWarehouse.UpdateRecord(Me) Then
    ...
    Dim SetControlsBindingOnNewAction As Action(Of Form) = AddressOf CWarehouse.SetControlsBindingOnNew
