    ...
    Friend Function GetClassData() As CClienteAreas
        ...
        Try
            ...
            Using oDataSet As New DataSet
                ...
                Using oSqlCommand As New SqlCommand("dbo.SP_PROCESS_CUSTOMER_AREAS")
    ...
    Public Shared Function SetControlsBinding(ByVal oForm As FClientes) As Boolean
        ...
        Try
            ...
            With oForm
                ...
                .tClaveId.DataBindings.Add("text", .oBindingSource, "rfc", True)
                .tClaveId.DataBindings.Add("text", .oBindingSource, "razon_social", True)
                .tClaveId.DataBindings.Add("text", .oBindingSource, "contacto", True)
                .tClaveId.DataBindings.Add("text", .oBindingSource, "email", True)
                .tClaveId.DataBindings.Add("text", .oBindingSource, "telefono", True)
                .tClaveId.DataBindings.Add("text", .oBindingSource, "celular", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "pais", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "ciudad", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "calle", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "nombre", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "numero_ext", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "numero_int", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "colonia", True)
                .tNombre.DataBindings.Add("text", .oBindingSource, "delegacion", True)
